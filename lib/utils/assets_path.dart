...
class AssetsPath {
  ...
  static const String _rhymeSound= 'assets/sounds/rhymes/';
  ...
  static String getBirdSound(String name) {
   ...
   static String getRhymeSound(String name) {
    return _rhymeSound + name;
  }
...
class Rhymes{
  static const String twinkleSound = 'twinkle.mp3';
  static const String babaSound = 'baba.mp3';
}
