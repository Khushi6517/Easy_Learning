        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8.0),
              _buildSectionContent(context, 'Developed by: Khushi Singh'),
              const SizedBox(height: 16.0),
              _buildSectionTitle(context, 'Purpose of the App:'),
              const SizedBox(height: 8.0),
              _buildSectionContent(
                context,
                'Easy_Learning is designed to provide a fun and interactive learning experience for kids. '
             ...
             _buildSectionContent(
              ...
              Row(
                children: [
                  _buildIcon(context, 'https://github.com/Khushi6517',
                      'assets/images/github.svg'),
                  const SizedBox(width: 16.0),
                  _buildIcon(context, 'mailto:khushisingh2184@gmail.com',
                      'assets/images/email.svg'),
                  const SizedBox(width: 16.0),
                  GestureDetector(
                    onTap: () {
                      _launchURL(
                          context, 'https://www.linkedin.com/in/khushi-singh-483bba221');
                    },
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSectionContent(
              context,
              'We value your feedback! If you have any suggestions or issues, please contact us at khushisingh2184@gmail.com or through our social media channels.',
            ),
          ],
        ),
      ),
